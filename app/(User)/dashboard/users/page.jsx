...
export default function Users() {
  ...
  useEffect(() => {
    const getCurrentUser = async () => {
      ...
      try {
        const response = await fetch("https://nodejs-login-signup.vercel.app/api/user/current", {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
        });
  ...
  const handleDelete = async (user) => {
    ...
    try {
      ...
      const response = await fetch("https://nodejs-login-signup.vercel.app/api/user/delete-user", {
        method: "DELETE",
        headers: {
