...
export default function AuthLayout({Actionbutton, img , text, actiontext , swapSides , Heading , form }) {
  return (
    <div className="flex sm:overflow-hidden flex-col h-fit sm:flex-row w-screen sm:min-h-screen sm:h-fit bg-gradient-to-b from-slate-900 to-indigo-600 sm:bg-gradient-to-r sm:from-slate-900 sm:to-indigo-700">
      ...
      <div id="left" className={`flex-col w-full sm:w-1/2 h-full ${swapSides ? 'sm:order-last' : 'sm:order-first'}`}>
        <div id="design-content" className="h-fit sm:h-[30%] flex flex-col justify-center items-center">
          <h1 className="text-center text-3xl font-bold text-white mt-5 sm:mt-10">
            {actiontext}
          </h1>
      ...
      <div id="right" className="flex-col w-full sm:w-1/2 h-full sm:mt-10 sm:flex sm:justify-center sm:items-center">
